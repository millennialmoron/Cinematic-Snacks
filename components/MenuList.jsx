  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.desc}>
        ...
        theater snacks? How about when you're binging your new favorite Netflix
        series (or let's face it, The Office) and wishing you could be binging
        on some great food too? We got you. Cinematic Snacks is here to match
        the vibe of whatever you're in the mood for, whether it's Cory's
